...
<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=28&pause=1000&color=FF9F1A&center=true&vCenter=true&random=false&width=524&lines=%E2%8A%B9+WELCOME+TO+MY+PROFILE!+%CB%99%E1%B5%95%CB%99+%E2%8A%B9+" alt="Typing SVG"> 
  </a>
</div>


<p align="center">
I'm Cesar Iglesias, an Information Systems student focused on cybersecurity, with hands-on experience in SOC and Blue Team operations, working with security monitoring, alert analysis, and incident response using SIEM platforms such as IBM QRadar and Google SecOps, EDR with CrowdStrike Falcon, and SOAR automation via IBM QRadar SOAR, along with technologies like Telmix IPS, F5 and Akamai WAF, UPX Anti-DDoS, Trend Micro email security, and OpenDNS / Cisco Umbrella. I am currently a Cyber Security intern in the Security Operations Center (SOC) at Bradesco, where I actively participate in incident investigation, war rooms, threat response, and operational security processes in a hybrid enterprise environment.
</p>
 
<h2 align="center">💬 About me: 💬 </h2>
<h3>
🛡️ - Cybersecurity Intern – SOC @ Bradesco <br>
👨‍💻 - Blue Team | Incident Response | Threat Detection <br>
🎓 - Information Systems Student (FIAP – 7th Semester / Final Year) <br>
🧠 - Hands-on experience with SIEM, EDR, SOAR and enterprise security tools <br>
☕ - Fun fact: Coffee-powered during incident response <br><br>

🌐 - Digital Card: https://digital-card-eucesar.vercel.app <br>
💻 - GitHub: https://github.com/eucesar <br>
🇧🇷 Brazilian </h3>
